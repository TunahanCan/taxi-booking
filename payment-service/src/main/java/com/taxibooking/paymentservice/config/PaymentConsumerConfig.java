...
public class PaymentConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PaymentTriggerDTO> paymentTriggerKafkaListenerContainerFactory() {
        return createListenerContainerFactory(PaymentTriggerDTO.class);
    }
}